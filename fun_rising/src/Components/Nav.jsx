          ...
          <div className="row achieve_inner">
            <div className="col-lg-12 col-md-6 text-center personal_tittle ">
              <p>
                ...
                needs. In short term liquidity, by striving to make funds
                available to them within 24 hours of application.
              </p>
            ...
            >
              <div className="achieve" style={{ height: "100%" }}>
                ...
                <p>
                  We are giving the best consultation to our customers with our
            ...
            >
              <div className="achieve" style={{ height: "100%" }}>
                ...
                <p>
                  We are providing loans to our customers with a lower amount of
                  processing charges.
                </p>
              </div>
            </div>
