        ...
        <div className="">
            ...
            <div className="container">
              <div className="header_top_inner row m-0">
                <ul className="top_menu col-lg-6 col-md-7 p-0">
                  ...
                  <li>
                    <a href="#">info@fundfinder.in</a>
                  </li>
                  <li>
                    <a href="disclaimer.html">Privacy disclaimer</a>
                  </li>
                </ul>
          ...
          <header className="main_header_area">
            <div className="container">
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#">
                          <i class="bi bi-telephone-fill"></i> 73973 12482
                        </a>
                      </li>
                    </ul>
                  </div>
              ...
              <div
                className="mt-5 py-3 text-center mt-4"
                style={{ color: "white" }}
              >
                <h2 className="fs-1 mt-5">
                  {" "}
                  We are the One Stop Solutions for all types of{" "}
                  <span style={{ color: "#fd7e14" }}>Loans</span>
                </h2>
                <div
                  className="d-flex theme-btn mt-5 p-5"
        ...
        <section className="achieve_financial_area">
          <div className="container">
            <div className="tittle">
              ...
              <h2 className="mt-5">
                You can achieve your financial goals. <span>We can help.</span>
              </h2>
            </div>
            <div className="row achieve_inner">
              <div className="col-lg-12 col-md-6 text-center personal_tittle ">
                <p>
                  We will match you with a loan program that meets your
                  financial needs. In short term liquidity, by striving to make
                  funds available to them within 24 hours of application.
                </p>
              ...
              >
                <div className="achieve" style={{ height: "100%" }}>
                  {" "}
                  {/* Add fixed height */}
                  ...
                  <p>
                    We are giving the best consultation to our customers with
              ...
              >
                <div className="achieve" style={{ height: "100%" }}>
                  ...
                  <p>
                    We are providing loans to our customers with a lower amount
              ...
              >
                <div className="achieve" style={{ height: "100%" }}>
                  ...
                  <p>
                    We provide 24/7 customer service support to our customers.
                  </p>
                </div>
              </div>
              <div
            ...
            <div className="col-md-6">
              <div className="">
                <div>
                  ...
                  <h5 className="pt-2 font-subhead">
                    We operate our banking services in all over chennai.
                  </h5>
                  <p className="pt-2">
                    Established in the year 2017, Fund Finder in Chennai, We are
                    top player in the category Personal loan, Business loan,
                    Loan against Property and Home Loans arranging with all
                    private and nationalized banks in Chennai.
                  </p>
                  <div className="py-2 text-center">
                    {" "}
                    <button className="about-bt">Call Now: xxxxx xxxxx</button>
                  </div>
                </div>
                <div className="pt-2">
      ...
      <section>
        <div className="container">
          <div className="py-3 text-center">
            ...
            <h5 className="font-subhead pt-3">
              We are modern and special for Quick Approval and Disbursement with
                ...
                <div>
                  ...
                  <div className="p-3 text-center">
                    ...
                    <p className="font-subhead">
                      There were times, when something we want or need to buy is
                      slightly out of our financial reach. But as finance market
                      is at rapid growth money is at your finger tips, you just
                      have to search for a good loan lender in chennai and
                      borrow a loan to fulfill your personal requirements.
                    </p>
              ...
              <div className="card-about">
                <div>
                  ...
                  <div className="p-3 text-center">
                    ...
                    <p className="font-subhead">
                      We always ready to help you as we understand your needs we
                      can help you to render business loan at very low interest
                      rate. Business loan are always useful for escalating
                      existing business on higher level, renovating and refining
                      existing medium or small businesses.
                    </p>
                    <button className="about-bt">Apply Now</button>
                  </div>
                </div>
              ...
              <div className="card-about">
                <div>
                  ...
                  <div className="p-3 text-center">
                    ...
                    <p className="font-subhead">
                      We always ready to help you as we understand your needs we
                      can help you to render home loan at very low interest
                      rate. If you are spending good amount in paying house rent
                      in chennai Looking for buying a free hold home, flats but
                      doesn’t have enough money to pay complete cost.
                    </p>
                    <button className="about-bt">Apply Now</button>
                  </div>
                </div>
              ...
              <div className="card-about">
                <div>
                  ...
                  <div className="p-3 text-center">
                    ...
                    <p className="font-subhead">
                      We always ready to help you as we understand your needs we
                      can help you to render loan against property at low
                      interest in chennai as in today’s scenario we never know
                      when we required money it can be any reason.
                    </p>
                    <button className="about-bt">Apply Now</button>
                  </div>
                </div>
                ...
                <div className="bg-white cards ">
                  <div className="py-3 px-4">
                    ...
                    <div className="justify-content-center d-flex pt-5">
                      <button className="py-2 px-3 border-0 btn-bg rounded-3 text-white font-style button-color ">
                        Apply Now
                      </button>
                    </div>
                  </div>
